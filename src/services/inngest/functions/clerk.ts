...
import {
    ...
    insertUser,
    updateUser,
} from "@/src/features/users/db/user";
import { insertUserNotificationSettings } from "@/src/features/users/db/userNotificationSettings";
...
export const clerkDeleteUser = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        await step.run("delte user", async () => {
